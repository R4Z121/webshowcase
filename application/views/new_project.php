...
<body>
    ...
    <main>
        ...
        <section class="form addform">
            <form action="<?= BASEURL; ?>/Actions/addweb" method="POST" enctype="multipart/form-data">
                <h3>Add new website project</h3>
                <label for="webname">Website Name</label>
                <input type="text" class="input" id="webname" name="webname" required>
                <label for="weburl">Website URL</label>
                <input type="text" class="input" id="weburl" name="weburl" required>
                <label>Picture</label>
                <img src="<?= BASEURL; ?>/assets/img/website/default_website.jpg" class="webpict" id="webpict">
                ...
                <button type="submit" class="action-form addform">add website</button>
            </form>
        </section>
    </main>
    <footer>
